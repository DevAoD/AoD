...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occured. AoD can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
// TODO: implement qtipcserver.cpp for Mac and Windows
    ...
    {
        if (strlen(argv[i]) >= 7 && strncasecmp(argv[i], "AoD:", 11) == 0)
        {
    ...
    app.setOrganizationName("AoD");
    app.setOrganizationDomain("AoD.net");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("AoD-Qt-testnet");
    else
        app.setApplicationName("AoD-Qt");
