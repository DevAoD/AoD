...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("AoD");
    case mBTC: return QString("m-AoD");
    case uBTC: return QString::fromUtf8("μ-AoD");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("AoD");
    case mBTC: return QString("Milli-AoD (1 / 1,000)");
    case uBTC: return QString("Micro-AoD (1 / 1,000,000)");
    default: return QString("???");
    }
}
