...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm send AoD"),
    ...
    case WalletModel::InvalidAddress:
        QMessageBox::warning(this, tr("Send AoD"),
    ...
    case WalletModel::TransactionCommitFailed:
        QMessageBox::warning(this, tr("Send AoD"),
            tr("Error: The transaction was rejected.  This might happen if some of the AoD in your wallet were already spent, such as if you used a copy of wallet.dat and AoD were spent in the copy but not marked as spent here."),
            QMessageBox::Ok, QMessageBox::Ok);
        break;
