        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start AoD on system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start AoD after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the AoD client port on the router. This only works when your router supports UPnP and it is enabled."));
    layout->addWidget(map_port_upnp);

    connect_socks4 = new QCheckBox(tr("&Connect through SOCKS4 proxy:"));
    connect_socks4->setToolTip(tr("Connect to the AoD network through a SOCKS4 proxy (e.g. when connecting through Tor)"));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show AoD addresses in the transaction list"));
