 ...
 * The AoDcoin Developers 2011-2013
 * The AoD Developers 2013-2014
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("AoD Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/AoD"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&Receive AoD"), this);
    receiveCoinsAction->setToolTip(tr("Show the list of addresses for receiving payments"));
    receiveCoinsAction->setCheckable(true);
    receiveCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_3));
    tabGroup->addAction(receiveCoinsAction);

    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Send AoD"), this);
    sendCoinsAction->setToolTip(tr("Send AoD to a AoD address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/AoD"), tr("&About %1").arg(qApp->applicationName()), this);
    aboutAction->setToolTip(tr("Show information about AoD"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for AoD"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/AoD"), tr("Show/Hide &AoD"), this);
    toggleHideAction->setToolTip(tr("Show or hide the AoD window"));
    ...
    exportAoDcoinKeysAction = new QAction(QIcon(":/icons/export"), tr("&Export AoDcoin keys"), this);
    exportAoDcoinKeysAction->setToolTip(tr("Export the AoDcoin keys associated with the AoD addresses to AoDcoin via RPC"));
    ...
    connect(exportAoDcoinKeysAction, SIGNAL(triggered()), this, SLOT(exportAoDcoinKeys()));
...
void BitcoinGUI::createMenuBar()
{
    ...
    QMenu *AoD = appMenuBar->addMenu(tr("S&hares"));
    AoD->addAction(exportAoDcoinKeysAction);
	AoD->addAction(distributeDividendsAction);
...
#ifndef Q_WS_MAC
            setWindowIcon(QIcon(":icons/AoD_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/AoD_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("AoD client"));
    ...
    notificator = new Notificator(tr("AoD-qt"), trayIcon);
}
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide AoD"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AoD network", "", count));
}
...
void BitcoinGUI::exportAoDcoinKeys()
{
    try {
        int iExportedCount, iErrorCount;
        walletModel->ExportAoDcoinKeys(iExportedCount, iErrorCount);
        QMessageBox::information(this,
                tr("AoDcoin keys export"),
                tr("%1 key(s) were exported to AoDcoin.\n%2 key(s) were either already known or invalid.")
                  .arg(iExportedCount)
                  .arg(iErrorCount)
                );
    }
