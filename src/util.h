...
// Copyright (c) 2012 The AoDcoin developers
...
extern std::map<std::string, std::string> mapAoDcoinArgs;
extern bool fDebug;
...
const boost::filesystem::path &GetAoDcoinDataDir(bool fNetSpecific = true);
boost::filesystem::path GetConfigFile();
boost::filesystem::path GetAoDcoinConfigFile();
boost::filesystem::path GetPidFile();
void CreatePidFile(const boost::filesystem::path &path, pid_t pid);
void ReadConfigFile(std::map<std::string, std::string>& mapSettingsRet, std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet);
void ReadAoDcoinConfigFile(std::map<std::string, std::string>& mapSettingsRet);
...
bool GetAoDcoinBoolArg(const std::string& strArg, bool fDefault=false);
