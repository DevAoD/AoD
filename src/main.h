...
static const int64 MAX_MINT_PROOF_OF_WORK = 99999 * COIN;
static const int64 MIN_TXOUT_AMOUNT = MIN_TX_FEE;
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
static const int COINBASE_MATURITY_PPC = 100; 
// Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp.
static const int LOCKTIME_THRESHOLD = 500000000; // Tue Nov  5 00:53:20 1985 UTC
static const int STAKE_TARGET_SPACING = 60 * 30; // AoD: 30 minute block spacing 
static const int STAKE_MIN_AGE = 60 * 60 * 8; // AoD: Minimum age for coin age changed to 8 hrs
static const int STAKE_MAX_AGE = 60 * 60 * 24 * 90; // AoD: Stake age of full weight 
static const int64 IPO_SHARES = 20000000 * COIN; // AoD: Total number of shares to create using proof of work (intented for IPO)
static const int64 PROOF_OF_WORK_BLOCKS = 400; // AoD: Block height of the last proof of work block
...
public:
    ...
    {
        // AoDcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    /** Amount of AoD spent by this transaction.
    ...
    /** Amount of AoD coming in to this transaction
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // AoDcoin: get transaction coin age
...
public:
    ...
    // AoDcoin: block signature - signed by coin base txout[0]'s owner
    ...
    // AoDcoin: entropy bit for stake modifier if chosen by modifier
    ...
    // AoDcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // AoDcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // AoDcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // AoDcoin: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // AoDcoin: block index flags
    enum  
    {
