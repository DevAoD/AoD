...
// AoD message start (switched from Bitcoin's in AoDcoin v0.2)
static unsigned char pchMessageStartBitcoin[4] = { 0xf9, 0xbe, 0xb4, 0xd9 };
static unsigned char pchMessageStartAoD[4] = { 0xe6, 0xe8, 0xe9, 0xe5 };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartAoD : pchMessageStartBitcoin, sizeof(pchMessageStartAoD));
}
