...
namespace Checkpoints
{
    ...
    // AoD: synchronized checkpoint (centrally broadcasted)
    ...
    // AoD: get last synchronized checkpoint
    ...
    // AoD: only descendant of current sync-checkpoint is allowed
    ...
    // AoD: reset synchronized checkpoint to last hardened checkpoint
...
// AoD: sync-checkpoint master key
...
// AoD: verify signature of sync-checkpoint message
...
// AoD: process synchronized checkpoint
